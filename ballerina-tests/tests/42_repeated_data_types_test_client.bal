...
function testServerStreamingWithDifferentTypes() returns error? {
    ...
    stream<Int64ArrMsg, grpc:Error?> int64Strm = check ep->helloWithInt64Array("int64");
    int c2 = 0;
    ...
    stream<UnsignedInt64ArrMsg, grpc:Error?> unsignedInt64Strm = check ep->helloWithUnsignedInt64Array("uint64");
    int c3 = 0;
    ...
    stream<Fixed32ArrMsg, grpc:Error?> fixed32Strm = check ep->helloWithFixed32Array("fixed32");
    int c4 = 0;
    ...
    stream<Fixed64ArrMsg, grpc:Error?> fixed64Strm = check ep->helloWithFixed64Array("sint64");
    int c5 = 0;
    ...
    stream<FloatArrMsg, grpc:Error?> floatStrm = check ep->helloWithFloatArray("float");
    int c6 = 0;
    ...
    stream<DoubleArrMsg, grpc:Error?> doubleStrm = check ep->helloWithDoubleArray("double");
    int c7 = 0;
    ...
    stream<StringArrMsg, grpc:Error?> stringStrm = check ep->helloWithStringArray("string");
    int c8 = 0;
    ...
    stream<BooleanArrMsg, grpc:Error?> booleanStrm = check ep->helloWithBooleanArray("boolean");
    int c9 = 0;
    ...
    stream<BytesArrMsg, grpc:Error?> bytesStrm = check ep->helloWithBytesArray("bytes");
    int c10 = 0;
